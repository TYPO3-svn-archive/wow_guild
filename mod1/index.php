...
/**
 * Module 'WOW Guild' for the 'wow_guild' extension.
 *
					...
					switch((string)$this->MOD_SETTINGS['function'])	{
						case 1:
							$content='<div align="center"><strong>Hello World!</strong></div><br />
								The "Kickstarter" has made this module automatically, it contains a default framework for a backend module but apart from that it does nothing useful until you open the script '.substr(t3lib_extMgm::extPath('wow_guild'),strlen(PATH_site)).$pathSuffix.'index.php and edit it!
								<hr />

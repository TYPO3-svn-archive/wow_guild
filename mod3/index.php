...
$LANG->includeLLFile('EXT:wow_guild/mod3/locallang.xml');
require_once(PATH_t3lib.'class.t3lib_scbase.php');
$BE_USER->modAccess($MCONF,1);	// This checks permissions and exits if the users has no permission for entry.
// DEFAULT initialization of a module [END]

// include user class
require_once ( t3lib_extMgm::extPath('wow_guild').'mod3/class.tx_wowguild_mod3.php' );
 ...
 */
class  tx_wowguild_module3 extends t3lib_SCbase {
				var $pageinfo;
          ...
          $tx_wowguild_mod3 = t3lib_div::makeInstance('tx_wowguild_mod3');
					$this->content .= $tx_wowguild_mod3->main();
				}
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wow_guild/mod3/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wow_guild/mod3/index.php']);
}
...
// Make instance:
$SOBE = t3lib_div::makeInstance('tx_wowguild_module3');
$SOBE->init();
